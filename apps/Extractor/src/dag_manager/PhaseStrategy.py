...
class PhaseStrategy(ABC):
    ...
    def run_task(self, country: str, vertical: str, target: str, system_target: str, leaf_name):
        """Dirige vers la bonne sous-methode selon le mode de reprise."""
