...
class ExceptionHandler(BaseExceptionHandler):
    ...
    def handle_exception(self, exception, context):
        ...
        # Fusionner le contexte additionnel (classe, flow, target, system, error_class, detail...)
    ...
    def _resolve_exception_type(self, exception):
        ...
        if exception_type == "Py4JJavaError":
            ...
            # Detecter les sous-types Spark encapsules dans le Py4JJavaError
    ...
    def get_error_info(self, exception):
        ...
        # Recuperer un resume de la trace (fichier, ligne, fonction du point d'origine)
        stack_trace = self._summarize_traceback(exception)

        # Extraire des details supplementaires pour les erreurs Spark SQL
    ...
    def _summarize_traceback(self, exception):
        ...
        # Prendre le dernier frame dans le code du projet (pas les libs externes)
        ...
        # Extraire uniquement le premier paragraphe du message d'erreur (avant les details Spark)
