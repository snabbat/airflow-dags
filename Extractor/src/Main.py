...
# Racine du projet — calculee dynamiquement a partir de Extractor/src/
...
if __name__ == '__main__':
    ...
    try:
        ...
        exception_log_path = os.path.join(PROJECT_ROOT, "Extractor", "Log", "Exception.log")
        ...
        # ALTERED: supprime les filtres target/system_target pour executer tous les flows
        success = dataloader.execute(country="Maroc", phase="extraction", vertical="SAHAM_BANK")
        end_time = datetime.now()
        time_diff = end_time - start_time
        print("-----------------------------------------------------")
        print("The time of Extraction phase execution: ", time_diff.total_seconds(), "seconds")
        print("-----------------------------------------------------")
